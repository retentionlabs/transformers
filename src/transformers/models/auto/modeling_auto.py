...
MODEL_FOR_PRETRAINING_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("ttt_linear", "TTTLinearForCausalLM"),
        ("ttt_mlp", "TTTMLPForCausalLM"),
...
MODEL_FOR_IMAGE_CLASSIFICATION_MAPPING_NAMES = OrderedDict(
    [
        ...
        ("ttt_linear", "TTTLinearForImageClassification"),
        ("ttt_mlp", "TTTMLPForImageClassification"),
